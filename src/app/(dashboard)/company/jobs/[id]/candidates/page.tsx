...
import { useCompanyApplications, useUpdateApplicationStatus, useHireCandidate, useRejectCandidate, usePreselectCandidate } from "@/hooks/use-job-applications";
...
export default function JobCandidatesPage() {
  ...
  const { data: jobOffer, loading: jobLoading } = useJobOffer(jobId);
  const { data: applications, loading: applicationsLoading } = useCompanyApplications();
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            <h1 className="text-2xl font-semibold tracking-tight">
              {authLoading ? "Verificando autenticación..." : "Cargando candidatos..."}
            </h1>
          </div>
        </div>
      </div>
