...
export default function InstitutionCourseManagementPage() {
  ...
  // Filter courses to only show those created by this institution
  const institutionId = "institution-1"; // TODO: Get from auth context
  const courses = allCourses?.filter(course => course.organizationId === institutionId) || [];
  ...
  // Calculate comprehensive stats for institution courses
    ...
    return (
      <div className="container mx-auto py-6">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">No se pudieron cargar los cursos de la institución</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">🎓 Gestión de Cursos de la Institución</h1>
          <p className="text-muted-foreground mt-2">
            Administra los cursos creados por tu institución educativa
          </p>
        </div>
        <div className="flex gap-3">
          ...
          <Link href="/institutions/courses/create">
            <Button>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Cursos de la Institución ({filteredCourses.length})</CardTitle>
        </CardHeader>
        <CardContent>
          {filteredCourses.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-4">
                Comienza creando tu primer curso para la institución
              </p>
              <Link href="/institutions/courses/create">
                <Button>
                  <Plus className="h-4 w-4 mr-2" />
