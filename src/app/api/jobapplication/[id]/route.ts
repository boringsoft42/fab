...
export async function GET(
  ...
  try {
    ...
    console.log('🔍 API: Received request for job application:', resolvedParams.id);
    
    const url = new URL(`${API_BASE}/jobapplication/${resolvedParams.id}`);
    ...
    console.log('🔍 API: Backend data received for job application:', resolvedParams.id);
...
export async function PUT(
  ...
  try {
    ...
    const data = await response.json();
    console.log('🔍 API: Backend data received for job application update:', resolvedParams.id);
    return NextResponse.json(data, { status: response.status });
  } catch (error) {
...
export async function DELETE(
  ...
  try {
    ...
    const data = await response.json();
    console.log('🔍 API: Backend data received for job application deletion:', resolvedParams.id);
    return NextResponse.json(data, { status: response.status });
  } catch (error) {
