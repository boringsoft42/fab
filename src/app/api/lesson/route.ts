...
export async function GET(request: NextRequest) {
  try {
    ...
    if (moduleId) {
      ...
      return NextResponse.json({ lessons: transformedLessons }, { status: 200 });
    }
...
export async function PUT(request: NextRequest) {
  try {
    console.log('📚 API: Received PUT request for lesson update');
...
export async function DELETE(request: NextRequest) {
  try {
    console.log('📚 API: Received DELETE request for lesson');
