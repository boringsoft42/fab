...
import * as AlertDialogPrimitive from &ldquo;@radix-ui/react-alert-dialog&rdquo;
...
AlertDialogHeader.displayName = &ldquo;AlertDialogHeader&rdquo;
...
AlertDialogFooter.displayName = &ldquo;AlertDialogFooter&rdquo;
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn(&ldquo;text-lg font-semibold&rdquo;, className)}
    {...props}
  />
))
