...
const ModuleCertificatePDF: React.FC<ModuleCertificatePDFProps> = ({ certificate }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.certificateContainer}>
          <Text style={styles.certificateTitle}>Certificado de Completación</Text>
          
          <Text style={styles.certificateText}>
            Se certifica que el estudiante ha completado exitosamente el módulo del curso correspondiente,
            demostrando competencia en los conocimientos y habilidades requeridas.
          </Text>
          ...
          <Text style={[styles.gradeInfo, { color: getGradeColor(certificate.grade) }]}>
